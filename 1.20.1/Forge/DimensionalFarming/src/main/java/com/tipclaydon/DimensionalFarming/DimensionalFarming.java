...
public class DimensionalFarming {
    ...
    public static void onCommonSetup(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            StrippableUtil.registerStrippable(ModBlocks.BLOODBARK_STEM.get(), ModBlocks.STRIPPED_BLOODBARK_STEM.get());
            StrippableUtil.registerStrippable(ModBlocks.BLOODBARK_HYPHAE.get(), ModBlocks.STRIPPED_BLOODBARK_HYPHAE.get());
        });
    }
