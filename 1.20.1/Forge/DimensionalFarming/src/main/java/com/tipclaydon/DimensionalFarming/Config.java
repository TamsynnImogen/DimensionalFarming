...
public class Config {
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_STRINGS = BUILDER
            .comment("A list of item ResourceLocations to log on common setup.")
    ...
    // Choose one of these depending on what you're after:
    public static Set<Item> items = new HashSet<>();
    // public static Set<ResourceLocation> items = new HashSet<>();
