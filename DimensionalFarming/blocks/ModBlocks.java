...
import com.tipclaydon.DimensionalFarming.blocks.StrippableHelper;
...
public class ModBlocks {
    ...
    public static void setupStrippables() {
        StrippableHelper.registerStrippable(BLOODBARK_STEM.get(), STRIPPED_BLOODBARK_STEM.get());
        StrippableHelper.registerStrippable(BLOODBARK_HYPHAE.get(), STRIPPED_BLOODBARK_HYPHAE.get());
    }
